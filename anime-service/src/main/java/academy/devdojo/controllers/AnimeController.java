...
public class AnimeController {
    ...
    @PutMapping
    public ResponseEntity<Void> deleteById(@RequestBody AnimePutRequest request) {
        ...
        int i = Anime.getAnimes().indexOf(animeToRemove);
        Anime.getAnimes().set(i, animeUpdated);
